        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="text-white space-y-6 sm:space-y-8">
            <div className="inline-block px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full border border-white/20">
              <span className="text-sm text-white">EU Cloud Sovereignty & Compliance</span>
            </div>
            ...
            <p className="text-lg sm:text-xl text-white/90 max-w-xl">
              Wir helfen mittelständischen und großen Unternehmen, ihre IT- und Cloud-Infrastruktur 
              compliant, datensouverän und effizient zu modernisieren.
            </p>
            ...
            <div className="grid grid-cols-3 gap-6 pt-8 border-t border-white/20">
              <div>
                <div className="text-3xl sm:text-4xl text-[#00C9A7]">150+</div>
                <div className="text-sm text-white/80 mt-1">Projekte</div>
              </div>
              <div>
                <div className="text-3xl sm:text-4xl text-[#00C9A7]">98%</div>
                <div className="text-sm text-white/80 mt-1">Kundenzufriedenheit</div>
              </div>
              <div>
                <div className="text-3xl sm:text-4xl text-[#00C9A7]">15+</div>
                <div className="text-sm text-white/80 mt-1">Jahre Erfahrung</div>
              </div>
            </div>
          </div>
